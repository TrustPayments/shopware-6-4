...
namespace TrustPaymentsPayment\Core\Api\PaymentMethodConfiguration\Entity;
 ...
 *
 * @package TrustPaymentsPayment\Core\Api\PaymentMethodConfiguration\Entity
 */
class PaymentMethodConfigurationEntityDefinition extends EntityDefinition {

	public const ENTITY_NAME = 'trustpayments_payment_method_configuration';
