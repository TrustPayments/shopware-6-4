...
namespace TrustPaymentsPayment\Core\Api\WebHooks\Struct;
 ...
 * Class Entity
 *
 * @package TrustPaymentsPayment\Core\Api\WebHooks\Struct
 */
class Entity extends Struct {
	...
	/**
	 * @param int $id
	 * @return \TrustPaymentsPayment\Core\Api\WebHooks\Struct\Entity
	 */
