...
use TrustPaymentsPayment\Core\Checkout\PaymentHandler\TrustPaymentsPaymentHandler;
...
class PaymentMethodUtil {
	 ...
	 */
	public function setTrustPaymentsAsDefaultPaymentMethod(Context $context, ?string $salesChannelId = null): void
	{
		$paymentMethodIds = $this->getTrustPaymentsPaymentMethodIds($context);
	 ...
	 * @return array
	 */
	public function getTrustPaymentsPaymentMethodIds(Context $context): array
	{
	...
	protected function getSystemPaymentMethodIds(Context $context): array
	{
		$criteria = (new Criteria())
			->addFilter(new NotFilter(
				...
				[
					new EqualsFilter('handlerIdentifier', TrustPaymentsPaymentHandler::class),
				]
			));
