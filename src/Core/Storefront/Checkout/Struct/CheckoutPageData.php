...
namespace TrustPaymentsPayment\Core\Storefront\Checkout\Struct;
 ...
 *
 * @package TrustPaymentsPayment\Storefront\Checkout\Struct
 */
class CheckoutPageData extends Struct {
	 ...
	 * @return \TrustPaymentsPayment\Core\Storefront\Checkout\Struct\CheckoutPageData
	 */
	public function setDeviceJavascriptUrl(int $spaceId, string $sessionId): CheckoutPageData
	{
		$this->deviceJavascriptUrl = strtr('https://ep.trustpayments.com/s/{spaceId}/payment/device.js?sessionIdentifier={sessionId}', [
			'{spaceId}'   => $spaceId,
			'{sessionId}' => $sessionId,
		]);
		return $this;
