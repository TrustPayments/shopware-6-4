...
class TrustPaymentsCheckoutPlugin extends Plugin {

    static options = {
        payment_method_tabs: 'ul.trustpayments-payment-panel li',
        payment_method_iframe_prefix: 'iframe_payment_method_',
        payment_method_iframe_class: '.trustpayments-payment-iframe',
        payment_method_handler_name: 'trustpayments_payment_handler',
        payment_method_handler_prefix: 'trustpayments_handler_',
...
export default TrustPaymentsCheckoutPlugin;